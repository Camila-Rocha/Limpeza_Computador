...
public class IconeInformacao
{
    ...
    public PictureBox Icone  { get; } = new PictureBox { Image = Properties.Resources.ico_info,
                                    Size = new Size(20, 20), Location = new Point(0, 0), SizeMode = PictureBoxSizeMode.Zoom };
